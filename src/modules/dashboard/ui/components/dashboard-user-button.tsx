        ...
        return (
            <Drawer>
                <DrawerTrigger asChild>
                    <div className="rounded-lg border-border/10 p-3 w-full flex items-center justify-between bg-white/5 hover:bg-white/10 overflow-hidden gap-x-2">
                        {data.user.image ?(
                            <Avatar>
                ...
                <DrawerContent>
                    ...
                    <DrawerFooter>
                        ...
                        <Button variant="outline" className="w-full items-center" onClick={onLogout}>
                            Logout
            ...
            <DropdownMenuContent align="end" side="right" className="w-72">
                <DropdownMenuLabel>
                    <div className="flex flex-col gap-1">
                        ...
                        <span className="text-sm text-muted-foreground font-normal truncate">{data.user.email}</span>
                    </div>
                </DropdownMenuLabel>
